...
public class ConnectedThread extends Thread {
    ...
    public static OutputStream getMmOutStream() {
        return mmOutStream;
    }

    public static void setMmOutStream(OutputStream mmOutStream) {
        ConnectedThread.mmOutStream = mmOutStream;
    }
    ...
    public Handler getUih() {
        return uih;
    }

    public void setUih(Handler uih) {
        this.uih = uih;
    }
}
